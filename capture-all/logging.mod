...
http://central.maven.org/maven2/ch/qos/logback/logback-core/1.1.6/logback-core-1.1.6.jar|lib/logging/logback-core-1.1.6.jar
http://central.maven.org/maven2/ch/qos/logback/logback-classic/1.1.6/logback-classic-1.1.6.jar|lib/logging/logback-classic-1.1.6.jar
